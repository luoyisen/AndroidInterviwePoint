...
/**
 * Created by yincheng on 2018/3/24.
 */
...
public abstract class AsyncTask<Params, Progress, Result> {
    ...
    // getHandler() 为什么又 getMainHandler()
    ...
    //AsyncTask里面的Handler只有两个作用，一个是调用onProgressUpdate方法，一个是finish方法，finish时候调用:mStatus = AsyncTask.Status.FINISHED;
